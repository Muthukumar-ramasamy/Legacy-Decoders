...
export const Popup = (props: any) => {
    ...
    return (
        ...
        >
            <Stack sx={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: "98%", padding: "12px", ml: 2 }}>
                <Stack>
                    <Typography sx={{ color: "" }} variant="h6" component="div">
                        {props?.header}
                    </Typography>
                </Stack>
                <Stack sx={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", cursor: "pointer", mr: 2}}  onClick={() => handleClose()}>
